...
const SidebarOverlay = ({ styles }) => {
  ...
  return (
    <div
      className={`${styles} bg-secondary-Background text-primary-headings rounded-2xl flex flex-col justify-between items-center py-8 min-h-full ${styles}`}
    >
      <div className="h-full flex flex-col justify-center items-center gap-3 w-full">
        ...
        <Link
          to={"/trade-journal"}
          onClick={() => {
            setSelectedSidebar("trade-journal");
            setOverlaySidebarOpen();
          }}
          className={`flex justify-start gap-2 w-[90%] p-[5%] rounded-lg  ${
        ...
        <Link
          to={"/risk-calculator"}
          onClick={() => {
            setSelectedSidebar("risk-calculator");
            setOverlaySidebarOpen();
          }}
          className={`flex justify-start gap-2 w-[90%] p-[5%] rounded-lg  ${
        ...
        <Link
          to={"/back-tester"}
          onClick={() => {
            setSelectedSidebar("back-tester");
            setOverlaySidebarOpen();
          }}
          className={`flex justify-start gap-2 w-[90%] p-[5%] rounded-lg  ${
